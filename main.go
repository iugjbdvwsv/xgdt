...
func parseCli() (string, int, string) {
	...
	var adminUserId int
	var proxy string
	flag.StringVar(&token, "token", "5605582485:AAFvy69m5BwRcuVRriMk9pj9mu4nQlXcB2c", "Bot token generated by BotFather")
	flag.IntVar(&adminUserId, "uid", 3442423, "Your telegram user id. Only enabled users can use this bot.")
